    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="updateCost.do" method="post" class="main_form" >
                ...
                <div class="input_info"><input type="text" class="readonly"  value="${cost.costId }" name="costId" readonly="readonly"/></div>
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" value="${cost.descr }" name="descr">${cost.descr }
                    </textarea>
